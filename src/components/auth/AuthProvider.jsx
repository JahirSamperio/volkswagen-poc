...
export const AuthProvider = ({ children }) => {
  ...
  const signOutGlobal = async () => {
    try {
      ...
      window.location.href = 'https://us-east-1bzgeloc9g.auth.us-east-1.amazoncognito.com/logout?client_id=u41vq0son5fab0l4fnc8eusuv&logout_uri=http%3A%2F%2Flocalhost%3A5173%2F';
    } catch (error) {
